...
single value, not use a map with only the `null` key!
...
Here you can find all CSS Grid related global settings.
You can use them to create your own CSS Grid layout.

!> **WARNING: Broken changes!** Since version 3.0.0 the Grid Object was removed.
